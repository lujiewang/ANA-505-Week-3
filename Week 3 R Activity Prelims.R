...
df <- data.frame(w_height,w_weight)
...
ggplot(women, aes(x=height, y=weight)) + 
  geom_point(shape = 10, colour = "black", fill = "white", size = 2, stroke = 5)
